<?php $page_title="Manage DNS Blacklist";
    include("includes/header.php");
    require("includes/lb_helper.php");
    require("language/language.php");
    
    $tableName="tbl_xui_dns_block";   
    $targetpage = "manage_blacklist.php"; 
    $limit = 15; 
    ...
    $sql_query="SELECT * FROM tbl_xui_dns_block ORDER BY tbl_xui_dns_block.`id` DESC LIMIT $start, $limit"; 
        ...
        <div class="card h-100">
            <div class="card-header d-md-inline-flex align-items-center justify-content-between py-3 px-4">
                ...
                <div class="d-flex mt-2 mt-md-0">
                    <a href="create_blacklist.php?add=yes" class="btn btn-primary d-inline-flex align-items-center justify-content-center">
                        <i class="ri-add-line"></i>
                        <span class="ps-1 text-nowrap d-none d-sm-block">Create Blacklist</span>
                    </a>
                </div>
            </div>
                        ...
                        <?php $i=0; while($row=mysqli_fetch_array($result)) { ?>
                            <div class="col-lg-3 col-sm-6">
                                <div class="nsofts-card-light p-3">
                                    <h5 class="mb-2"><?php echo $row['dns_base'];?></h5>
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                           <a href="create_blacklist.php?dns_id=<?php echo $row['id'];?>" class="btn btn-outline-primary rounded-pill me-2 btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
