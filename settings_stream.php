<?php $page_title="Settings 1-Stream";
    ...
    if(isset($_POST['app_submit'])){
        ...
        $data = array(
            'is_stream_dns'  =>  ($_POST['is_stream_dns']) ? 'true' : 'false',
            'is_stream_radio'  =>  ($_POST['is_stream_radio']) ? 'true' : 'false'
        );
        ...
        header("Location:settings_stream.php");
        exit;
    }
?>
                            ...
                            <div class="tab-pane fade show active" id="nsofts_setting_content_1" role="tabpanel" aria-labelledby="nsofts_setting_1" tabindex="0">
                                <form action="" name="settings_app" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="nsofts-switch d-flex align-items-center">
                                                <input type="checkbox" id="is_stream_dns" name="is_stream_dns" value="true" class="cbx hidden" <?php if($settings_data['is_stream_dns']=='true'){ echo 'checked'; }?>/>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="nsofts-switch d-flex align-items-center">
                                                <input type="checkbox" id="is_stream_radio" name="is_stream_radio" value="true" class="cbx hidden" <?php if($settings_data['is_stream_radio']=='true'){ echo 'checked'; }?>/>
