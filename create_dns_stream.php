<?php 
    ...
    if(isset($_POST['submit']) and isset($_GET['add'])){
        ...
        $qry = Insert('tbl_stream_dns',$data);
        
        $_SESSION['msg']="10";
        $_SESSION['class']='success';
        header( "Location:manage_dns_stream.php");
        exit;
    }
    
    if(isset($_GET['dns_id'])){
        $qry="SELECT * FROM tbl_stream_dns where id='".$_GET['dns_id']."'";
    ...
    if(isset($_POST['submit']) and isset($_POST['dns_id'])){
        ...
        $category_edit=Update('tbl_stream_dns', $data, "WHERE id = '".$_POST['dns_id']."'");
        
        $_SESSION['msg']="11";
        $_SESSION['class']='success';
        header( "Location:create_dns_stream.php?dns_id=".$_POST['dns_id']);
        exit;
    }
?>
