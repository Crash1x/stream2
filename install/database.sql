...
--
-- Host: localhost:3306
-- Generation Time: Jan 03, 2024 at 05:16 AM
...
INSERT INTO `tbl_settings` (`id`, `app_name`, `app_logo`, `app_email`, `app_author`, `app_contact`, `app_website`, `app_description`, `app_developed_by`, `app_privacy_policy`, `app_terms`, `account_delete_intruction`, `envato_buyer_name`, `envato_purchase_code`, `envato_package_name`, `envato_api_key`, `onesignal_app_id`, `onesignal_rest_key`, `is_rtl`, `is_maintenance`, `is_screenshot`, `is_apk`, `is_vpn`, `is_xui_dns`, `app_update_status`, `app_new_version`, `app_update_desc`, `app_redirect_url`, `custom_ads`, `custom_ads_clicks`, `is_theme`, `is_dowload`, `is_xui_radio`, `ad_network`, `publisher_id`, `banner_ad`, `banner_ad_id`, `interstital_ad`, `interstital_ad_id`, `interstital_ad_click`, `ads_limits`, `ads_count_click`, `is_select_xui`, `is_select_stream`, `is_select_playlist`, `is_select_device_id`, `is_select_single`, `is_stream_dns`, `is_stream_radio`) VALUES
(1, 'StreamBox', '44195_logo.png', 'info.nemosofts@gmail.com', 'nemosofts', '0356525684', 'nemosofts.com', '', 'thivakaran', '', '', '', '', '', 'nemosofts.streambox', '', '', '', 'false', 'false', 'false', 'true', 'true', 'true', 'false', 1, '', 'https://play.google.com/store/apps/details', 'false', 15, '1', 'true', 'false', 'admob', 'ca-app-pub-3940256099942544~3347511713', 'false', 'ca-app-pub-3940256099942544/6300978111', 'false', 'ca-app-pub-3940256099942544/1033173712', 20, 'true', 20, 'true', 'true', 'true', 'true', 'true', 'true', 'false');
...
(2, 'visual_editor', 'Visual Editor', 'ri-question-answer-fill', '<div><div>This is developed using the popular PHP framework <b>Codeigniter</b>. <font color=\"#ff0000\">Online Radio</font> this is website application for Radio.</div></div><div><br></div>', '', '', '', 1),
